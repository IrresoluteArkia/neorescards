...
public class PotionHealingTouch extends PotionBase{

	public PotionHealingTouch() {
	...
	public void renderInventoryEffect(EffectInstance effect, DisplayEffectsScreen<?> gui, int x, int y, float z) {
		...
		text.add("You feel very attuned to living things, so attuned, in fact,");
		text.add("that just a touch from you eases their pains.");
